...
FunctionsToExport = 'Get-Dashboard', 'Get-Push', 'Get-PushAuditLog', 'Get-SecretLink', 
               'Initialize-PassPushPosh', 'New-Push', 'Remove-Push', 
               'New-PasswordPush', 'ConvertTo-PasswordPush'
