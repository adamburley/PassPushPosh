...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = @'
### 0.3.0
- Updated scope for module metadata from GLOBAL to SCRIPT
- Removed associated PSScriptAnalyzer attribute tags

### 0.2.2
- Fixed issue with Get-Dashboard returning error referencing -JsonIsArray parameter

### 0.2.0
- First release. Module is generally functional but has not been extensively bug-tested. Reccomend not implementing into a production environment at this time.
'@
